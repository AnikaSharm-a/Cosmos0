class Moon extends CelestialBody {
  ...
  void drawMoon(){
    ...
    if (zoom == 25) {
      ...
      else if (phase == 4) { noFill(); stroke(0); strokeWeight(15); ellipse(x+5, y, this.diameter+10, this.diameter+15); } // waxing gibbous
      else if (phase == 6) { noFill(); stroke(0); strokeWeight(15); ellipse(x-5, y, this.diameter+10, this.diameter+15); } // waning gibbous
